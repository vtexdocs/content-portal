  ...
  return (
    <>
      <Head>
        ...
        <meta name="docsearch:doctype" content="interface-copy" />
...
export const getStaticPaths: GetStaticPaths = async () => {
  ...
  const docsPaths = await getTracksPaths('interface-copy')
...
export const getStaticProps: GetStaticProps = async ({
  ...
  if (!docsPathsGLOBAL) {
    docsPathsGLOBAL = await getTracksPaths('interface-copy')
  }
  const docsPaths =
    preview || process.env.NEXT_PHASE !== PHASE_PRODUCTION_BUILD
      ? await getTracksPaths('interface-copy', branch)
      : docsPathsGLOBAL
