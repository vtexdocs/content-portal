...
const docsPathsGLOBAL = await getTracksPaths('glossary')
...
export const getStaticProps: GetStaticProps = async ({
  ...
  const docsPaths =
    process.env.NEXT_PHASE === PHASE_PRODUCTION_BUILD
      ? docsPathsGLOBAL
      : await getTracksPaths('glossary', branch)
  ...
  try {
    ...
    parentsArrayName.forEach((_el: string, idx: number) => {
      breadcrumbList.push({
        slug: `/docs/glossary/${parentsArray[idx]}`,
