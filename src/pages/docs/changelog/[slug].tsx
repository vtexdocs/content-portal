...
const docsPathsGLOBAL = await getTracksPaths('changelog')
  ...
  return (
    <>
      <Head>
        ...
        <meta name="docsearch:doctype" content="changelog" />
...
export const getStaticProps: GetStaticProps = async ({
  ...
  const docsPaths =
    process.env.NEXT_PHASE === PHASE_PRODUCTION_BUILD
      ? docsPathsGLOBAL
      : await getTracksPaths('changelog', branch)
  ...
  try {
    ...
    parentsArrayName.forEach((_el: string, idx: number) => {
      breadcrumbList.push({
        slug: `/docs/changelog/${parentsArray[idx]}`,
