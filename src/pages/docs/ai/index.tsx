...
import AiImage from '../../../../public/images/cs-ai_desktop.png'
import AiImageMobile from '../../../../public/images/cs-ai_mobile.png'
...
const AiSectionPage: NextPage<Props> = ({ branch }) => {
    ...
    <>
      ...
      <Fragment>
        <PageHeader
          ...
          imageUrlDesktop={AiImage}
          imageUrlMobile={AiImageMobile}
          imageAlt={intl.formatMessage({
            id: 'ai_card_subtitle',
          })}
        />
        <Box sx={styles.contentContainer}>
          <ContentSection id={'ai_page_section'} length={5} />
        </Box>
      </Fragment>
    </>
  )
